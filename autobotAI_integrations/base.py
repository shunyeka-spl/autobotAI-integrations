...
class BaseService:
    ...
    # Notification integrations (Slack, MS Teams, Google Chat, email â€¦) override
    ...
    # ``None`` means this integration is not a notification target â€” consumers
...
class AIBaseService(BaseService):
    ...
    def build_model_from_credentials(model_name: str, credentials: dict):
        ...
        instance â€” callers like llm_utils.quick_llm_call that only have an
