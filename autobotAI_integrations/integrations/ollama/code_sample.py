...
def executor(context):
    ...
    client = clients["ollama"]  # Supports only one client

    # User's Python code execution logic goes here
    # (Replace this comment with the your actual code)

    # Example: Getting response from gemma:2b(for illustration purposes only)
    # response = client.generate(
    #     model="gemma:2b", prompt="describe life in 20 words?", stream=False
    # )
